        ...
        <div className="row container">
            <div className="columns" data-aos="fade-right" data-aos-delay="300">
                ...
                <h4>
                    <FormattedMessage
                        id='description'
                        defaultMessage='My name is Ikramjanov Isroiljon Luqmonjonivich and I am a full stack developer.'
                    />
                </h4>
                <p>
                    <FormattedMessage
                    ...
                    <li>
                        <p>
                            <span>
                                ...
                                Voleball, Football and Programming
                        </p>
                    </li>
                    <li>
                        <p><span>Email:</span> IkramjanovIsroiljon@gmail.com</p>
                    </li>
                    <li>
                        <p>
                            <span>
                ...
                <div className="mas-info">
                    <a href="" target="_blank" rel="noopener noreferrer" className="btn-codigo buttonDownload">
                        <FormattedMessage
                            id='btn-cv'
                        />
                    </a>
